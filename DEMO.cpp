/*
This is code implement a thread-safe queue and set(hash-map). 
The goal to show the code is for demostrating my multi-thread programming skill and familiarity for STL. 
*/
